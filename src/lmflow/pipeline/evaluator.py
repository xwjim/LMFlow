    ...
    def _evaluate_acc_with_accelerator(self, model, dataset, verbose=True):
        ...
        for batch_index, batch in enumerate(dataloader):
            ...
            with self.accelerator.autocast():
                outputs = model.inference(inputs, max_new_tokens=500,attention_mask=mask,temperature=0.0,use_accelerator=self.evaluator_args.use_accelerator_for_evaluator)
